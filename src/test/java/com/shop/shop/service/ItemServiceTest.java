...
public class ItemServiceTest {
    ...
    /*MockMultipartFile 클래스를 이용하여 가짜 MultipartFile 리스트를 만들어서 반환해주는 메서드*/
    ...
    void saveItem() throws Exception{
        ItemFormDto itemFormDto = new ItemFormDto();/*상품 등록 화면에서 입력 받은 상품 데이터를 세팅해줌*/
        ...
        /*강품 데이터와 이미지 정보를 파라미터로 넘겨서 저장 후 저장된 상품의 아이디 값을 반환 값으로 리턴*/
        ...
        assertEquals(multipartFileList.get(0).getOriginalFilename(),
                itemImgList.get(0).getOriImgName());/*상품 이미지는 첫 번째 파일의 원본 이미지 파일 이름만 같은지 확인*/
