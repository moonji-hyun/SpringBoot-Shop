...
public class ItemImgDto {
    ...
    private static ModelMapper modelMapper = new ModelMapper();  // 맴버 변수로 ModelMapper 객체 추가
    ...
    public static ItemImgDto of(ItemImg itemImg) { // ItemImg를 파라미터로 받아서 자료형과 변수이름이 같을 때 ItemImgDto로 값을 복사해 반환
        ...
        /*ItemImg 엔티티 객체를 파라미터로 받아서  ItemImg 객체의 자료형과 멤버변수의 이름이 같을 때 ItemImgDto로
        값을 복사해서 반홤함. static 메소드로 선언해 ItemImgDto 객체를 생성하지 않아도 호출할 수 있도록 함*/
    }
}
